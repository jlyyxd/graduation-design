...
from networks.unet import UNet, UNet_DS, UNet_URPC, UNet_CCT, UNet_SIMSIAM
import argparse
...
def net_factory(net_type="unet", in_chns=1, class_num=3):
    ...
    elif net_type == "unet_simsiam":
        net = UNet_SIMSIAM(in_chns=in_chns, class_num=class_num).cuda()
