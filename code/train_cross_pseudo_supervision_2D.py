...
from dataloaders.dataset import (ImgDataSets, RandomGenerator,
...
# 建立数据集,在 /data/ACDC/ 下面
    db_train = ImgDataSets(base_dir=args.root_path, split="train", num=None, transform=transforms.Compose([
        RandomGenerator(args.patch_size)
    ]))# train数据集
    db_val = ImgDataSets(base_dir=args.root_path, split="val")# val数据集
